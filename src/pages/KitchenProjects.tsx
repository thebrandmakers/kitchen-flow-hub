...
import { ChefHat, ArrowLeft, Plus, Eye, Calendar, Users } from 'lucide-react';
      ...
      const { data, error } = await supabase
        ...
        .select(`
          *,
          ...
          kitchen_project_phases(phase_name, status, phase_number)
        `)
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading kitchen projects...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Modular kitchen project management</p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {projects && projects.length > 0 ? (
                ...
                <CardHeader>
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <CardTitle className="text-lg">{project.project_reference}</CardTitle>
                ...
                <CardContent>
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-medium">{project.budget_bracket}</span>
                    </div>
                    
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-500">Phase:</span>
                      <span className="font-medium">{project.current_phase || 1}/6</span>
                    </div>
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">No Kitchen Projects</h3>
            <p className="text-gray-500 mb-6">Get started by creating your first kitchen project.</p>
            <Button onClick={() => navigate('/kitchen-projects/new')}>
              <Plus className="h-4 w-4 mr-2" />
